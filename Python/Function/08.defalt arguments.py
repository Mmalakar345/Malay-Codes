...
def getSumAndDifference(num1,num2=30): #### Formal Parameter
    sum=num1+num2
    diff=num1-num2
    return sum,diff
## main ##
...
sum,diff=getSumAndDifference(n1) #### Actual Parameter
print("Sum => ",sum)
print("Difference =>",diff)

## Function call with exact number of arguments
sum,diff=getSumAndDifference(n1,n2) #### Actual Parameter
print("Sum =>",sum)
print("Difference => ",diff)